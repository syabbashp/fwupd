				   ...
				   GError **error)
{
	...
	fu_device_set_status(FU_DEVICE(device), FWUPD_STATUS_DEVICE_ERASE);
	...
	fu_device_set_progress(FU_DEVICE(device), 100); /* ISP is complete */
...
SECURE_AUX_ISP_END:
	...
	fu_device_sleep_with_progress(FU_DEVICE(device), 2);
